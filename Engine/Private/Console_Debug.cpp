...
unsigned int APIENTRY ThreadEntryFunc_Console_Debug(void* pArg)
{
	...
	while (true)
	{
		...
		cout << "ºû¿¬»ê ·»´õÅ¸°Ù (lightacc on/off)" << endl;
		cout << "ºû±íÀÌ ·»´õÅ¸°Ù (lightdepth on/off)" << endl;
		cout << "HDR ·»´õÅ¸°Ù (hdr on/off)" << endl;
		cout << "°á°ú ·»´õÅ¸°Ù (final on/off)" << endl;
		cout << "ÀÌÆåÆ® ·»´õÅ¸°Ù (effect on/off)" << endl;
