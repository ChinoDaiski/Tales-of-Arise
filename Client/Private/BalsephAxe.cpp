...
HRESULT CBalsephAxe::SetUp_Components()
{
	...
	/* For.Com_Model */
	if (FAILED(__super::SetUp_Components(TEXT("Com_Model"), LEVEL_LORD_BALSEPH, TEXT("Prototype_Component_Model_BalsephAXE"), (CComponent**)&m_pModelCom)))
		return E_FAIL;
...
HRESULT CBalsephAxe::SetUp_ConstantTable()
{
	...
	/*CTransform*		pPlayerTransform = (CTransform*)pGameInstance->Get_Component(LEVEL_LORD_BALSEPH, TEXT("Layer_Balseph"), CGameObject::m_pTransformTag, 0);
