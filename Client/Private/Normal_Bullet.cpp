...
HRESULT CNormal_Bullet::NativeConstruct_Prototype()
{
...
HRESULT CNormal_Bullet::NativeConstruct(void * pArg)
{
...
void CNormal_Bullet::Tick(_double TimeDelta)
{
...
void CNormal_Bullet::LateTick(_double TimeDelta)
{
...
HRESULT CNormal_Bullet::SetUp_Components()
{
	/* For.Com_Renderer */
...
HRESULT CNormal_Bullet::SetUp_ConstantTable()
{
	CGameInstance*		pGameInstance = GET_INSTANCE(CGameInstance);
...
CNormal_Bullet * CNormal_Bullet::Create(ID3D11Device* pDeviceOut, ID3D11DeviceContext* pDeviceContextOut)
{
	CNormal_Bullet*	pInstance = new CNormal_Bullet(pDeviceOut, pDeviceContextOut);

	if (FAILED(pInstance->NativeConstruct_Prototype()))
	{
		MSG_BOX(TEXT("Failed to Created CNormal_Bullet"));
