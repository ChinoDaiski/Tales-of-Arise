...
HRESULT CLoader_Map::Loading_ForTestLevel()
{
	m_isFinished = false;
...
HRESULT CLoader_Map::Loading_Test_Model()
{
	return S_OK;
}

HRESULT CLoader_Map::Loading_Test_Texture()
{
	return S_OK;
}

HRESULT CLoader_Map::Loading_Test_Object()
{
	return S_OK;
}
