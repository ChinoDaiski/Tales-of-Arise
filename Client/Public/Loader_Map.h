...
{
private:
	explicit CLoader_Map(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext);
...
public:
	static CLoader_Map* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext, LEVEL eLevel);
