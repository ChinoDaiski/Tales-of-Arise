...
class CLoader_Monster final : public CBase
{
private:
	explicit CLoader_Monster(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext);
	virtual ~CLoader_Monster() = default;
public:
...
public:
	static CLoader_Monster* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext, LEVEL eLevel);
