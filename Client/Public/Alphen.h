...
#pragma region Player State
	...
	enum ARI_SKILL
	{
		...
		//지상
		SKILL_LIGTHING_THRUST, SKILL_SWALLOW_BLADE, SKILL_DRAGON_SWARM, SKILL_RISING_WYVERN,
		//공중
	...
	{
		SKILL_GROUND_LIGTHING_THRUST, SKILL_GROUND_SWALLOW_BLADE, SKILL_GROUND_DRAGON_SWARM, SKILL_GROUND_RISING_WYVERN,SKILL_GROUND_END
	};
