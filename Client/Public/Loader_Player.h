...
class CLoader_Player final : public CBase
{
private:
	explicit CLoader_Player(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext);
	virtual ~CLoader_Player() = default;
public:
...
public:
	static CLoader_Player* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext, LEVEL eLevel);
