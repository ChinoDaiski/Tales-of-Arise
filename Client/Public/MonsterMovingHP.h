...
class MonsterMovingHP  final : public CGameObject
{
private:
	explicit MonsterMovingHP(ID3D11Device* pDeviceOut, ID3D11DeviceContext* pDeviceContextOut);
...
public:
	static MonsterMovingHP* Create(ID3D11Device* pDeviceOut, ID3D11DeviceContext* pDeviceContextOut);
